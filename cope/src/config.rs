...
pub const CONFIG: Config<3> = Config {
    ...
    relay: NodeID::new('B'),
    rx_whitelist: [
        (NodeID::new('A'), [Some(NodeID::new('B')), None, None]),
        (
            NodeID::new('B'),
            [Some(NodeID::new('A')), Some(NodeID::new('C')), None],
        ),
        (NodeID::new('C'), [Some(NodeID::new('B')), None, None]),
    ],
    tx_whitelist: [
        (NodeID::new('A'), [Some(NodeID::new('C')), None, None]),
        (
            NodeID::new('B'),
            [Some(NodeID::new('A')), Some(NodeID::new('C')), None],
        ),
        (NodeID::new('C'), [Some(NodeID::new('A')), None, None]),
    ],
    traffic_generators: [
        (
            NodeID::new('A'),
            TrafficGeneratorType::Periodic(Duration::new(1, 0)),
        ),
