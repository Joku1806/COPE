...
% [nocoverpage] - no cover page when generating the pdf
% [dedication] - dedication page after the title page

% Choose one of the following lines.
\group{Telecommunication Networks (TKN)}
...
%\thesistype{Dissertation}\thesiscite{PhD Thesis}
\thesisinstitution{School of Electrical Engineering and Computer Science}
\thesisschool{TU Berlin}
\thesiscity{Berlin, Germany}

% List of advisors, separated by commas. Delete if identical to referees or inapplicable.
\advisors{Peter Schuster}

% List of referees, separated by commas.
\referees{Prof.\ Dr.-Ing.\ habil.\ Falko Dressler, NN}
%
\thesubmissiondate{2. November 2022}
%
\placeandyear{Berlin 2023}

% For PhD Thesis title page
\orcid{0000-0000-0000-0000}
\thedefensedate{6. April 2023}
\faculty{Fakultät IV --- Elektrotechnik und Informatik}
\university{Technischen Universität Berlin}
% Chair of referee consortium
\refereechair{Prof. Dr. Committee Chair}
%
% List of advisors, separated by commas.
\advisors{Prof.\ Dr.-Ing.\ habil.\ Falko Dressler}
...
\TODO{This template is for use with \texttt{pdflatex} and \texttt{biber}. It has been tested with TeX~Live 2022 (as of 16 June, 2023).}
